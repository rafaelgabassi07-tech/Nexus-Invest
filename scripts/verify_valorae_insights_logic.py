...
checks = {
    ...
    "Top pagadores não simula proventos sem eventos confirmados": "estimateDividendForAssetAcrossPeriod" not in charts and "Sem eventos confirmados não cria ranking estimado" in charts,
    ...
    "Tabela IPCA alinha séries antes de calcular juros reais": "alignedIpcaTable" in charts and "resampleInsightSeries(ipcaDataValues, portDataValues.size.coerceAtLeast(2))" in charts,
